...
},
{
  ...
  "body": " Euler-Mascheroni constant  In the case where the function is the reciprocal function , the quantity is known as the Euler-Mascheroni constant, an important quantity in analysis and number theory where it occurs in many settings. It is still not known whether $\\gamma$ is irrational or not, though most would bet that it is.  "
}
]
